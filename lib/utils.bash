...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for foundry.
...
download_release() {
	...
	# TODO: Adapt the release URL convention for foundry
...
install_version() {
	...
	(
		...
		# TODO: Assert foundry executable exists.
		local tool_cmd
